...
## Articles
1. Valiquette, S. (In preparation). On the conditional independence for the multivariate Bernoulli distributions. Bernoulli.
2. Valiquette, S., Genest, C., Nešlehová, J. G. (In preparation). A class of multivariate Bernoulli distributions generated by an aggregation-tree model. Journal of Multivariate Analysis.
